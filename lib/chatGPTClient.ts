...
export class ChatGPTClient {
  ...
  async createImage(name: string, prompt: string): Promise<string[] | string> {
    ...
    const requestBody = {
      ...
      prompt,
      negative_prompt: "((cartoon)), (painting), (doll), ((drawing)), ((out of focus body)), ((out of focus face)), ((((ugly)))), (((duplicate))), ((morbid)), ((mutilated)), [out of frame], (extra fingers), (mutated hands), ((poorly drawn hands)), ((poorly drawn face)), (((mutation))), (((deformed))), ((ugly)), blurry, ((bad anatomy)), (((bad proportions))), ((extra limbs)), cloned face, (((disfigured))), out of frame, ugly, extra limbs, (bad anatomy), gross proportions, (malformed limbs), ((missing arms)), ((missing legs)), (((extra arms))), (((extra legs))), mutated hands, (fused fingers), (too many fingers), (((long neck))), ((cross-eyed)), cross eyed, ((big ears)), (text), (((watermark))), (watermarking)",
      "width": "512",
      "height": "512",
      "samples": "1",
